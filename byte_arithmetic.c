...
#define ADD_INSTR(r,R)	\
	INSTR(add_##r) {\
		...
		i8080_set_flag(&emu->i8080, FLAG_A, carry_out_lower_nibble(emu->i8080.A, emu->i8080.R));	\
...
INSTR(add_m) {
	...
	i8080_set_flag(&emu->i8080, FLAG_A, carry_out_lower_nibble(emu->i8080.A, byte));	// Auxiliary Carry Flag.
